...
class AgentAgency:
    ...
    def create_database_agent(self,system_message):
        db_expert= AssistantAgent( name='DatabaseExpert', model_client= self.model_client, workbench=McpConfig.get_mysql_workbench(), system_message= system_message )

        return db_expert

    def create_api_agent(self, system_message):
        restapi_workbench = McpConfig.get_restapi_workbench()
        filesystem_workbench = McpConfig.get_filesystem_workbench()
    ...
    def create_excel_agent(self, system_message):
        excel_workbench = McpConfig.get_excel_workbench()
